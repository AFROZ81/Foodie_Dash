...
namespace FoodieDash.Controllers
{
    public class MenuItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,ImageUrl,Price,CategoryId")] MenuItem menuItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,ImageUrl,Price,CategoryId")] MenuItem menuItem)
        {
            if (id != menuItem.Id)
            {
                return NotFound();
